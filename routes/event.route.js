...
import { getEventWithCustomerCount, registerCustomerForEvent , getRegisteredEventsForCustomer , EditEvent , DeleteEvent, getAllCloudEvents} from '../controllers/eventController.js';
...
router.get('/cloud/', verifyToken, getAllCloudEvents);
